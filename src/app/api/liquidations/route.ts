...
/**
 * GET /api/liquidations?page=1&limit=25&borrower=0x...&liquidator=0x...&collateral=SUI&debt=USDC&from=2026-01-01&to=2026-02-19
 * Paginated, filtered liquidation events.
 */
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('/api/liquidations error:', error);
